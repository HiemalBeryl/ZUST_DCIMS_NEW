...
public class DcimsBasicDataServiceImpl implements IDcimsBasicDataService {
    ...
    public void syncStudentInfo() {
        ...
        ResponseEntity<String> exchange = restTemplate.exchange(studentDataUrl + "?pageNum=1&pageSize=500", HttpMethod.GET, new HttpEntity<>(initRemoteAccessKey()), String.class);
        System.out.println(exchange.getBody());
    }
}
