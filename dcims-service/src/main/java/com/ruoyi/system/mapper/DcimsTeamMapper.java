...
public interface DcimsTeamMapper extends BaseMapperPlus<DcimsTeamMapper, DcimsTeam, DcimsTeamVo> {
    @Select({
        "<script>",
        "SELECT c.name, c.level, c.organizer, c.college, c.responsible_person_name, c.responsible_person_id, c.phone, c.single_race, c.province_time, c.national_time, c.teaching_hours, c.inner_student_count, t.competition_id, t.award_level, t.student_name, t.teacher_name, t.student_id, t.teacher_id, t.award_time, t.competition_type, t.competition_time FROM dcims_team AS t, dcims_competition AS c",
        "<where>",
